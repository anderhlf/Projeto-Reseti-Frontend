<template>
    <div class="min-h-screen flex items-center justify-center p-6 bg-cover bg-center bg-no-repeat"
        ...
        <div
            class="w-full max-w-md bg-white/70 backdrop-blur-xl rounded-[40px] shadow-2xl p-10 flex flex-col items-center border border-white/20">

            <div class="flex flex-col items-center gap-2 mb-14">
            ...
            <form @submit.prevent="handleLogin" class="w-full space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex justify-end pr-4 mt-1">
                        <router-link to="/redefinir-senha" class="text-xs font-bold text-blue-600 hover:underline">
                            Esqueceu a senha?
                        </router-link>
                    </div>
                </div>
            ...
            <div class="mt-14 text-center">
                <p class="text-gray-500 text-sm">
                    ...
                    <router-link to="/cadastro" class="text-blue-600 font-bold hover:underline">Crie uma
                        conta</router-link>
                </p>
            </div>
        </div>
